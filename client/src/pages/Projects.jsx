...
const ProjectsPage = () => {
  ...
  const fetchCareers = () => {
    axios
      .get("http://localhost:5000/api/projects/careerIds")
      .then((response) => {
  ...
  const handleSelectCareer = (careerId) => {
    ...
    axios
      .get(`http://localhost:5000/api/projects/${careerId}`)
      .then((response) => {
  ...
  const handleAddNewCareer = () => {
    if (newCareer.trim() !== "") {
      ...
      axios
        .post("http://localhost:5000/api/projects/process", careerObject)
        .then((response) => {
  ...
  const handleDeleteCareer = (careerId) => {
    axios
      .delete(`http://localhost:5000/api/projects/delete/${careerId}`)
      .then((response) => {
